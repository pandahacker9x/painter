...
import 'package:example/painter/serilaizable_path/serializable_path.dart';
import 'package:example/painter/serilizable_paint.dart';
...
class PathHistory {
  ...
  PathHistory()
      : _paths = <MapEntry<SerializablePath, SerializablePaint>>[],
        _inDrag = false,
  ...
  void updateCurrent(Offset nextPoint) {
    if (_inDrag) {
      SerializablePath path = _paths.last.key;
  ...
  factory PathHistory.fromJson(String source) =>
      PathHistory.fromMap(json.decode(source));
}
...
class PainterController extends ChangeNotifier {
  ...
  PainterController([PathHistory? pathHistory])
      : _pathHistory = pathHistory ?? new PathHistory();
  ...
  /// Returns serialized map of _pathHistory
  ///
  /// The returned serialized _pathHistory can be used to store or pass somewhere.
  /// see the [PainterController] constructor to create PainterController
  /// with serialzied PathHistory
  Map<String, dynamic> getPathHistoryMap() => _pathHistory.toMap();
